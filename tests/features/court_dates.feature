...
#  ## YAML-based translation uses values of the given language? Language-agnostic tests not feasible?
#  #When I tap the var "acknowledged_information_use" with the value "I accept."
...
#  And I tap the var "facts.tenant_address_is_eviction_address" with the value "True"
#  And I tap to continue
...
#  When I tap the var "tenant.name_different_on_summons" with the value "False"
#  When I tap to continue
...
#  # This is actually set by `default_landlord_type`, so not sure how to handle this default
#  And I tap the var "landlord.organization_type" with the value "other"
#  When I tap to continue
#  Then the question id should be "landlords attorney"
#  And I tap the var "landlord.has_attorney" with the value "False"
#  When I tap to continue
...
#  And I tap the var "ntq_includes_tenant_name" with the value "True"
#  And I tap the var "ntq_includes_all_tenants" with the value "True"
#  And I tap the var "ntq_includes_correct_address" with the value "True"
#  And I tap to continue
#  Then the question id should be "nonpayment defenses"
#  When I tap the var "behind_in_rent" with the value "True"
#  And I tap to continue
...
#  When I tap the var "ntq_matches_summons" with the value "True"
#  And I tap the var "summons_includes_all_tenants" with the value "True"
#  And I tap the var "summons_includes_correct_address" with the value "True"
#  When I tap to continue
#  Then the question id should be "nonpayment cure"
#  When I tap to continue
#  Then the question id should be "waiver"
#  # New step needed - set the var "" with the value "" to True/False or set the value "" of the var "" to True/False
#  #When I tap the var "post_ntq_waiver" with the value "rent"
#  #When I tap the var "ntq_contains_reservation" with the value "True"
#  And I tap to continue
#  Then the question id should be "have a defense"
#  When I tap to continue
#  Then the question id should be "bad conditions"
#  When I tap the var "bad_conditions.conditions" with the value "other"
#  And I tap to continue
...
#  And I tap the var "summons_includes_all_tenants" with the value "True"
#  And I tap the var "summons_includes_correct_address" with the value "True"
#  # This isn't there in the English or Spanish version
#  #And I tap the var "summons_eviction_reasons" with the value "same_fault"
#  When I tap to continue
#  Then the question id should be "nonpayment cure"
#  When I tap to continue
#  Then the question id should be "waiver"
...
#  When I tap to continue
#  Then the question id should be "bad conditions"
#  When I tap the var "bad_conditions.conditions"
#  And I tap to continue
#  Then the question id should be "retaliation splash"
#  When I set the var "retaliation.is_retaliated" to "False"
#  Then the question id should be "discrimination splash"
...
#  When I tap the var "subsidized_housing.no_proper_termination" with the value "True"
#  When I tap the var "subsidized_housing.no_just_cause" with the value "True"
#  When I tap the var "subsidized_housing.no_ntq_to_agency" with the value "False"
#  # This is default based on previous answers. Something about dv victims. Not sure how to decide this one.
#  When I tap the var "subsidized_housing.vawa" with the value "False"
#  And I tap to continue
